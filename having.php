...
<body>
    ...
    <div class="info-box">
        <h3>What is Having?</h3>
        <p>The HAVING clause in SQL is used to filter records after a GROUP BY operation. It works like the WHERE clause but is applied to groups of data rather than individual rows.</p>
    </div>

    <!-- Box 2: General Query for Select Distribution -->
    <div class="info-box">
        <h3>General SQL Query for Having</h3>
        <pre>
