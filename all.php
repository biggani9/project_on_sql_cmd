...
<body>
    ...
    <div class="info-box">
        <h3>What is All?</h3>
        <p>In SQL, the ALL function is used with comparison operators (e.g., =, >, <) to compare a value with all values in a subquery. The condition is true only if it satisfies the comparison for every value returned by the subquery.</p>
    </div>

    <!-- Box 2: General Query for Select Distribution -->
    <div class="info-box">
        <h3>General SQL Query for All</h3>
        <pre>
        SELECT column
        FROM table
