...
<body>
    ...
    <div class="info-box">
        ...
        <p>A LEFT JOIN in SQL retrieves all the data from the left table and the matching data from the right table. If there is no matching record in the right table, NULL values will be returned for those columns from the right table.</p>
    </div>

    <!-- Box 2: General Query for Select Distribution -->
    <div class="info-box">
        <h3>General SQL Query for Left Join</h3>
        <pre>
