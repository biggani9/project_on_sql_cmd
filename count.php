...
<body>
    ...
    <div class="info-box">
        <h3>What is Count?</h3>
        <p>The COUNT function in SQL is an aggregate function used to count the number of rows in a table or the number of non-NULL values in a specific column. It is commonly used to get the total number of records or to count specific entries based on certain conditions.</p>
    </div>

    <!-- Box 2: General Query for Select Distribution -->
    <div class="info-box">
        <h3>General SQL Query for Count</h3>
        <pre>
        SELECT COUNT(*) 
        FROM table_name;
