...
<body>
    ...
    <div class="info-box">
        <h3>What is Create view?</h3>
        <p>In SQL, a CREATE VIEW statement is used to create a virtual table based on a SELECT query. It does not store data itself but provides a saved, reusable query result that can be treated like a table.</p>
    </div>

    <!-- Box 2: General Query for Select Distribution -->
    <div class="info-box">
        <h3>General SQL Query for Create view</h3>
        <pre>
