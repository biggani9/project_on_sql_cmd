...
<body>
    ...
    <div class="info-box">
        <h3>What is a Select Distinct?</h3>
        <p>The SELECT DISTINCT statement in SQL is used to retrieve unique (non-duplicate) values from a column or a set of columns in a database table. It ensures that the results returned only contain distinct records, eliminating any duplicate entries.</p>
    </div>

    <!-- Box 2: General Query for Select Distribution -->
    <div class="info-box">
        <h3>General SQL Query for Select Distinct</h3>
        <pre>
