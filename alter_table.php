...
<body>
    ...
    <div class="info-box">
        ...
        <p>The ALTER TABLE statement is used in SQL to modify an existing table structure. This can include actions such as adding, deleting, or modifying columns, as well as renaming columns or tables.</p>
    </div>

    <!-- Box 2: General Query for Select Distribution -->
    <div class="info-box">
        <h3>General SQL Query for Alter Table </h3>
        <pre>
        Add a Column
